...
if __name__ == "__main__":
    caller = Caller('10.0.10.6','8545',"","0x00a329c0648769a73afac7f9381e08fb43dbea72")
    ident_spec_file = "ident.spec"
    contract_filename = "../contracts/HubCulture.sol"
    contract_spec_file = "contracts.spec"
    test_spec_file = "test.spec"
